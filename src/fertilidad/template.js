...
var box = yo`<div class="container">
    ...
    <div class="columns boxTrata small-12">
      ...
      <p>Consiste en colocar un número importante de espermatozoides capacitados previamente en laboratorio dentro del útero de la paciente que ha sido sometida a un ciclo de estimulación ovárica.</p>
    </div>
    <div class="columns boxTrata small-12">
